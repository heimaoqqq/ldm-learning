"""
VAE集成的扩散模型
基于OpenAI improved-diffusion架构，适配VAE潜在空间生成
"""
import math
import torch
...
class VAEDiffusionUNet(nn.Module):
    """
    VAE集成的U-Net模型，用于在潜在空间中进行扩散
    """
    def __init__(
        self,
        image_size=32,  # 修正：VAE潜在空间分辨率是32×32
        in_channels=256,  # VAE潜在空间维度
        model_channels=128,
        out_channels=256,  # VAE潜在空间维度
        num_res_blocks=2,
